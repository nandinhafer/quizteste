...
const questions = [
  {
    question: "(Produção agropecuária no Brasil) pecuária é a atividade produtiva de criação de animais que tem como propósito a produção de alimentos como:?",
    answers: [
      { text: "Carnes, ovos, leite, couros e lãs", correct: true  },
      { text: "Grãos e hortaliças", correct: false },
      { text: "Gramíneas e leguminosas", correct: false},
      { text: "Verduras, legumes, frutas e cereais", correct: false }
    ]
  },
  {
    question: "(Produção agrícola no Brasil) Quais são os principais produtos a serem colhidos?",
    answers: [
      { text: "Milho, trigo e feijão", correct: true },
      { text: "", correct: false },
